	...
	<script type="text/javascript">
		...
		$(function(){
			...
			datagrid = $('#datagrid').datagrid({
				url : '${app}/financeThreshold/pageList',
				title : '融资日指标',
				toolbar:"#toolbars",
				border : false,
				singleSelect : true,
				...
				},
				{
					...
					formatter:function(value,rowData,rowIndex){
						...
						var threeCodeName = rowData.threeCodeName;
						var fourCodeName = rowData.fourCodeName;
						
						var beginValue = rowData.beginValue;
						var endValue = rowData.endValue;
						var threeValue = rowData.threeValue;
						var fourValue = rowData.fourValue;
						
						var redMath = rowData.redMath;
						var redMathTwo = rowData.redMathTwo;
						var yellowMathOne = rowData.yellowMathOne;
						var yellowMathTwo = rowData.yellowMathTwo;
						var yellowMathThree = rowData.yellowMathThree;
						var yellowMathFour = rowData.yellowMathFour;
						var blueMath = rowData.blueMath;
						var blueMathTwo = rowData.blueMathTwo;
						var retStr = '<a href="javascript:financingEdit(\'' + beginCodeName + '\',\'' + endCodeName + '\',\'' + threeCodeName + '\',\'' + fourCodeName + '\',\'' + beginValue + '\',\'' + endValue + '\',\'' + threeValue + '\',\'' + fourValue + '\',\'' + redMath + '\',\'' + yellowMathOne + '\',\'' + yellowMathTwo + '\',\'' + blueMath + '\',\'' + codeName + '\',\'' + redMathTwo + '\',\'' + yellowMathThree + '\',\'' + yellowMathFour + '\',\'' + blueMathTwo + '\')">修改</a>';
						return retStr;
					}
				}]]
			});
			...
			datagrid2 = $('#datagrid2').datagrid({
				url : '${app}/financeThreshold/pageMonthList',
				title : '融资月指标',
				toolbar:"#toolbars",
				border : false,
				singleSelect : true,
