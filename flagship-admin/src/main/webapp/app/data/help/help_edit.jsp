...
<html>
  <head>
	...
	$(function(){
		...
		function submitForm() {
			...
			var base = new Base64();
			var isHot = $("input:checkbox:checked").val() 
			...
			$.ajax({
				type: "post",
	             url: "${app}/help/doEdit",
	             data: {"id":id,"sortId":sortId,"question":question,"answer":answer,"isHot":isHot},
	             dataType: "json",
	             success: function(data){
	            	parent.createTab('${app}/app/data/help/help_list.jsp','帮助');
					parent.closeTab("修改帮助问题");
	             }
			})
  ...
  <body style="background: white;">
  	<form id="addForm" class="easyui-form" method="post" modelAttribute="appuser">
		 <input id="contentId" type="hidden" name="id" value="${helpContent.cid}">
		<table class="tableForm" border="1" width="100%" >
			<tr>
				<td width="15%" class="tdR"><span style="color: red">*</span>选择分类:</td>
				<td>
					<input id="type" value="${helpContent.sid}" style="width: 200px;"   class="easyui-combobox"  name="sortId"
					data-options="
					...
					">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input name="tname" type="checkbox" value="1"><span style="color: red">*</span>热门</td>
				</td>
				</tr>
			<tr>
				<td width="15%" class="tdR"><span style="color: red">*</span>问题描述:</td>
				<td>
					<textarea  id="question"  style="width:645px;height:50px;" name="question">${helpContent.question}</textarea>
				</td>
			</tr> 
			<tr>
				<td width="15%" class="tdR"><span style="color: red">*</span>问题解答:</td>
				<td>
					<textarea id="text" style="width:650px;height:360px;" name="pictureFile">${helpContent.answer}</textarea> 
				</td>
			</tr> 
			<tr>
