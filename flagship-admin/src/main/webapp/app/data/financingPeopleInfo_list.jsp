  ...
  <head>
	...
	function upload() {
	      ...
	      $("#form").ajaxSubmit({
	          type : 'POST',
	          dataType:"json",
	          url:'${app}/finance/peopleInfo/doUpload',
	...
	function downLoad(){
		...
		$(function(){
			...
			datagrid = $('#datagrid').datagrid({
				url : '${app}/finance/peopleInfo/pageList',
				title : '',
				pagination : true,
		...
		function clearFromFun(datagrid){
			location.href="${app}/app/data/financingPeopleInfo_list.jsp";
		}
  ...
  <form id="searchForm">
		 ...
		 <form id="form"  enctype="multipart/form-data">
			 <table>
	  		...
	  		<input type="hidden" id="path" name="ruleName" value="融资人员信息表.xlsx" >
	</form>
	</div>
	</div>
