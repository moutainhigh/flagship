	...
	<script type="text/javascript">
		...
		$(function(){
			...
			datagrid = $('#datagrid').datagrid({    
			    url:'${app}/risk/getCm1GradingDailyList',    
			    pagination : true,
				singleSelect : true,
  ...
  <form id="searchForm">
 		<table border="0" class="searchForm datagrid-toolbar" width="100%" height="100%">
 			<tr>
				...
				<td width="5px"></td>
			<td width="200px">
				<input  id="record_date" name="recordDate" editable='false' maxlength="20" class='easyui-datebox' style="width: 150px;height: 24px;" data-options="required:false" placeholder ="--请选择日期--"/>
			</td>
