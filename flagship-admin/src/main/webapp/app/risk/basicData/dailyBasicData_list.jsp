  ...
  <head>
	...
	<script type="text/javascript">
		...
		$(function(){
			 ...
			 $('#cm1_daily_time').datebox().datebox('calendar').calendar({ 
				...
				$("#cm1_daily_time").datebox("setValue",theDayBeforeFormatter(curr_time));  
	        ...
	        */
		        ...
		        //分中心 和市场风险管理部（只允许查询x期前）
		         if(rank == 6 || "fengkongglb" == no){
			        ...
			        if(rank == 3){
						//通过所属事业部编号 加载大区
			        	getDistrictName(no,'');
			        	//$('#cm1_business_unit_name').combobox('select',no);
	        ...
	        //时间
	        var cm1_time  =$("#cm1_daily_time").datebox('getValue');
	        //批次
	        ...
	        datagrid = $('#datagrid').datagrid({
				url : '${app}/risk/getCm1OverDetailList?status='+'daily',
				title : '',
				pagination : true,
		...
		function clearFromFun(datagrid){
			location.href="${app}/risk/toDailyBasicDataList";
		}
		//导出Excel
        function doExport(){
        	//事业部 赋值
            ...
            $("#searchForm").attr("action", "${app}/risk/riskBasicDataExport?isExport='daily'&status="+'daily');
	    ...
	    <div title="C-M1回款率" style="background-color: #F4F4F4;" > 
		  		...
		  		<table border="0"  cellpadding="0" cellspacing="0" style="margin-top: 10px;">
		  			<tr>
						...
						<span style="margin-left: 20px;" ></span>   
						 选择日期:
						<input id="cm1_daily_time"  name="cm1_time" editable='false' maxlength="30" class='easyui-datebox' style="width: 150px;height: 24px;margin-top: 100px;" data-options="required:false"/>
				...
				<tr>
					<td>
					     	...
					     	<span style="margin-left: 20px;" ></span> 
					     	   大区名称：
							<input id="cm1_district_name"   style="width:150px;"  value="全部" class="easyui-combobox" >
					       ...
					       <span style="margin-left: 20px;" ></span> 
							...
							<select id="cm1_is_overdue" name="cm1_is_overdue" class="easyui-combobox" panelHeight="auto" name="dept" style="width:150px;">   
							 ...
							 <sec:authorize ifAnyGranted='${ctrl.dailyDataExport}'>
