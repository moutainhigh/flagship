...
public class EmployeeServiceImpl implements EmployeeService{
	...
	/**
	 * Description: 根据员工id 查找员工权限
	 * @param employeeId
	 * @return
	 * @author guodong
	 */
	@Override
	public Map<String, Object> selectByEmployeeId(Integer employeeId) {
		return employeePermissionRelationMapper.selectByEmployeeId(employeeId);
	}
	/**
	 * Description: 修改员工权限
	 * @param employeeId
